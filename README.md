...
Data were checked for unique accessions in each table then merged.
...
up that code. Here I've manually set many theme components but built-in themes could be substituted if suitable. <br>
